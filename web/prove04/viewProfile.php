        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                ...
                <div align="center" style="; border: 1px solid black;">
                    ...
                    foreach ($db->query('SELECT image_path, title, id, image_likes FROM images WHERE user_uploaded_id=' . $queryID) as $row) {
                        echo '<div>';
                    ...
                    foreach ($db->query('SELECT video_path, title, id, video_likes FROM videos WHERE user_uploaded_id=' . $queryID) as $row) {
